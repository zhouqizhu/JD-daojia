...
<div class="mask" v-if="showCart && calculations.total > 0" @click="handleCartShowChange"></div>
  <div class="cart">
    <div class="product" v-if="showCart && calculations.total > 0">
      ...
      <div class="prduct__item" v-for="item in productList" :key="item._id">
...
const useCartEffect = (shopId) => {
  ...
  return { calculations, productList, setCartItemsChecked, changeCartItemInfo, changeCartItemChecked, cleanCartProducts }
}
...
export default {
  ...
  setup () {
    ...
    const {
      ...
      setCartItemsChecked, changeCartItemInfo, changeCartItemChecked, cleanCartProducts
    } = useCartEffect(shopId)
    const { showCart, handleCartShowChange } = toggleCartEffect()
    return { calculations, showCart, productList, shopId, handleCartShowChange, setCartItemsChecked, changeCartItemInfo, changeCartItemChecked, cleanCartProducts }
  }
}
</script>
